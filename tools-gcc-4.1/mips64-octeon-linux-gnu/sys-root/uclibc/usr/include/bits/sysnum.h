...
#define __NR_migrate_pages (6000 + 250)
#define SYS_migrate_pages __NR_migrate_pages
#undef __NR_openat
#define __NR_openat (6000 + 251)
#define SYS_openat __NR_openat
#undef __NR_mkdirat
#define __NR_mkdirat (6000 + 252)
#define SYS_mkdirat __NR_mkdirat
#undef __NR_mknodat
#define __NR_mknodat (6000 + 253)
#define SYS_mknodat __NR_mknodat
#undef __NR_fchownat
#define __NR_fchownat (6000 + 254)
#define SYS_fchownat __NR_fchownat
#undef __NR_futimesat
#define __NR_futimesat (6000 + 255)
#define SYS_futimesat __NR_futimesat
#undef __NR_newfstatat
#define __NR_newfstatat (6000 + 256)
#define SYS_newfstatat __NR_newfstatat
#undef __NR_unlinkat
#define __NR_unlinkat (6000 + 257)
#define SYS_unlinkat __NR_unlinkat
#undef __NR_renameat
#define __NR_renameat (6000 + 258)
#define SYS_renameat __NR_renameat
#undef __NR_linkat
#define __NR_linkat (6000 + 259)
#define SYS_linkat __NR_linkat
#undef __NR_symlinkat
#define __NR_symlinkat (6000 + 260)
#define SYS_symlinkat __NR_symlinkat
#undef __NR_readlinkat
#define __NR_readlinkat (6000 + 261)
#define SYS_readlinkat __NR_readlinkat
#undef __NR_fchmodat
#define __NR_fchmodat (6000 + 262)
#define SYS_fchmodat __NR_fchmodat
#undef __NR_faccessat
#define __NR_faccessat (6000 + 263)
#define SYS_faccessat __NR_faccessat
#undef __NR_pselect6
#define __NR_pselect6 (6000 + 264)
#define SYS_pselect6 __NR_pselect6
#undef __NR_ppoll
#define __NR_ppoll (6000 + 265)
#define SYS_ppoll __NR_ppoll
#undef __NR_unshare
#define __NR_unshare (6000 + 266)
#define SYS_unshare __NR_unshare
#undef __NR_splice
#define __NR_splice (6000 + 267)
#define SYS_splice __NR_splice
#undef __NR_sync_file_range
#define __NR_sync_file_range (6000 + 268)
#define SYS_sync_file_range __NR_sync_file_range
#undef __NR_tee
#define __NR_tee (6000 + 269)
#define SYS_tee __NR_tee
#undef __NR_vmsplice
#define __NR_vmsplice (6000 + 270)
#define SYS_vmsplice __NR_vmsplice
#undef __NR_move_pages
#define __NR_move_pages (6000 + 271)
#define SYS_move_pages __NR_move_pages
#undef __NR_set_robust_list
#define __NR_set_robust_list (6000 + 272)
#define SYS_set_robust_list __NR_set_robust_list
#undef __NR_get_robust_list
#define __NR_get_robust_list (6000 + 273)
#define SYS_get_robust_list __NR_get_robust_list
#undef __NR_kexec_load
#define __NR_kexec_load (6000 + 274)
#define SYS_kexec_load __NR_kexec_load
#undef __NR_getcpu
#define __NR_getcpu (6000 + 275)
#define SYS_getcpu __NR_getcpu
#undef __NR_epoll_pwait
#define __NR_epoll_pwait (6000 + 276)
#define SYS_epoll_pwait __NR_epoll_pwait
#undef __NR_ioprio_set
#define __NR_ioprio_set (6000 + 277)
#define SYS_ioprio_set __NR_ioprio_set
#undef __NR_ioprio_get
#define __NR_ioprio_get (6000 + 278)
