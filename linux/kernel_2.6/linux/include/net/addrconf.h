...
/* purpose     : NK_CONFIG_IPV6    author : paul.chen    date : 2010-11-22 */
/* description : fix bug for tahi                                          */
static inline int nk_ipv6_zeroaddr(const struct in6_addr *a)
{
	return ( (a->s6_addr32[0]==0) && (a->s6_addr32[1]==0) && (a->s6_addr32[2]==0) && (a->s6_addr32[3]==0) );
}

static inline int nk_ipv6_loopbackaddr(const struct in6_addr *a)
{
	return ( (a->s6_addr32[0]==0) && (a->s6_addr32[1]==0) && (a->s6_addr32[2]==0) && (a->s6_addr32[3]==1) );
}
