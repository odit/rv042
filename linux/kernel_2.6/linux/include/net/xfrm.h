...
extern int __xfrm_packet_check(struct sk_buff *skb, unsigned short family);
static inline int xfrm_packet_check(struct sk_buff *skb, unsigned short family)
{
		return __xfrm_packet_check(skb, family);
}
static inline int xfrm4_packet_check(struct sk_buff *skb)
{
	return xfrm_packet_check(skb, AF_INET);
}
