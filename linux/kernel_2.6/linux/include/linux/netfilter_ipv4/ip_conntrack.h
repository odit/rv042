...
struct ip_conntrack
{
	...
	struct {
		u_int64_t b_cnt;
		u_int64_t ct_bytes_pre;
		u_int64_t ct_bytes_delta;
		u_int64_t up_bytes;
		u_int64_t up_bytes_delta;
		u_int64_t up_bytes_pre;
		u_int64_t down_bytes;
		u_int64_t down_bytes_delta;
		u_int64_t down_bytes_pre;
		int update;
		int query;
		int flag;
	} tr;
