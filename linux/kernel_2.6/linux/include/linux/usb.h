...
#define NK_NL_PHYLINK_USB_UP					420		//	Netklass USB Device physical link up event number //Robert 2009/10/17
#define NK_NL_PHYLINK_USB_DOWN					421		//	Netklass USB Device physical link down event number //Robert 2009/10/17
#endif
...
#ifdef CONFIG_NK_SUPPORT_USB_3G
extern int send_to_user(int type, char cPort);
#endif
