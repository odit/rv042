...
#if 0 /* apply the definition of ipv4 */
...
unsigned int nf_ct_tcp_timeout_syn_sent =     24 SECS;
unsigned int nf_ct_tcp_timeout_syn_recv =     15 SECS;
unsigned int nf_ct_tcp_timeout_established =  30 MINS;
unsigned int nf_ct_tcp_timeout_fin_wait =     24 SECS;
unsigned int nf_ct_tcp_timeout_close_wait =   15 SECS;
unsigned int nf_ct_tcp_timeout_last_ack =      15 SECS;
unsigned int nf_ct_tcp_timeout_time_wait =    4 SECS;
unsigned int nf_ct_tcp_timeout_close =        4 SECS;
#endif
