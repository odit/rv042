...
unsigned int ip_ct_tcp_timeout_established =  30 MINS;
...
*/
/*aging time must be larger than nat_acc life time; (nat_acc aging time ~=9ms)*/
unsigned int ip_ct_tcp_timeout_syn_sent =     24 SECS;
//unsigned int ip_ct_tcp_timeout_syn_recv =     12 SECS;
unsigned int ip_ct_tcp_timeout_syn_recv =     15 SECS;
unsigned int ip_ct_tcp_timeout_established =  30 MINS;
unsigned int ip_ct_tcp_timeout_fin_wait =     24 SECS;
//unsigned int ip_ct_tcp_timeout_close_wait =   12 SECS;
unsigned int ip_ct_tcp_timeout_close_wait =   15 SECS;
//unsigned int ip_ct_tcp_timeout_last_ack =      12 SECS;
unsigned int ip_ct_tcp_timeout_last_ack =      15 SECS;
unsigned int ip_ct_tcp_timeout_time_wait =    4 SECS;
//unsigned int ip_ct_tcp_timeout_close =        10 SECS;
unsigned int ip_ct_tcp_timeout_close =        4 SECS;
