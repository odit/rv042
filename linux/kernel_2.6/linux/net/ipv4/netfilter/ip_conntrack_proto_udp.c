...
//unsigned int ip_ct_udp_timeout = 10*HZ;
unsigned int ip_ct_udp_timeout = 15*HZ;
//unsigned int ip_ct_udp_timeout_stream = 60*HZ;
unsigned int ip_ct_udp_timeout_stream = 30*HZ;
