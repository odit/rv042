 ...
 *
 *  $Id: clps711x.c 2 2007-04-05 08:51:12Z tt $
 *
 */
...
static int __init clps711xuart_init(void)
{
	...
	printk(KERN_INFO "Serial: CLPS711x driver $Revision: 2 $\n");
...
MODULE_DESCRIPTION("CLPS-711x generic serial driver $Revision: 2 $");
MODULE_LICENSE("GPL");
