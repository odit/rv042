...
#if 0 //def CONFIG_NK_SUPPORT_USB_3G	move to hub.c
	sprintf(ctmp,"%s",dev->bus_id);
//	dev_info(dev, "disconnect port2=%s\n",ctmp);
//	dev_info(dev, "disconnect port2=%c\n",ctmp[4]);
	
	send_to_user(NK_NL_PHYLINK_USB_DOWN, ctmp[4]);	  //Robert added 2009/10/17
#endif	
}
