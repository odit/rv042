...
/* $Id: nsp_cs.c 2 2007-04-05 08:51:12Z tt $ */
...
MODULE_DESCRIPTION("WorkBit NinjaSCSI-3 / NinjaSCSI-32Bi(16bit) PCMCIA SCSI host adapter module $Revision: 2 $");
...
static struct Scsi_Host *nsp_detect(struct scsi_host_template *sht)
{
	...
	snprintf(data->nspinfo,
		 sizeof(data->nspinfo),
		 "NinjaSCSI-3/32Bi Driver $Revision: 2 $ IO:0x%04lx-0x%04lx MMIO(virt addr):0x%04lx IRQ:%02d",
	...
	int    inout)
{
	...
	SPRINTF("Driver version:        $Revision: 2 $\n");
