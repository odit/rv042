...
/* $Id: applicom.c 2 2007-04-05 08:51:12Z tt $			     */
...
int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: applicom.c 2 2007-04-05 08:51:12Z tt $\n");
...
{				/* @ ADG ou ATO selon le cas */
	...
	case 5:
		...
		break;
	case 6:
		printk(KERN_INFO "APPLICOM driver release .... V2.8.0 ($Revision: 2 $)\n");
