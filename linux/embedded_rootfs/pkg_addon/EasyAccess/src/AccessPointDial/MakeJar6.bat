...
del .\Release\WindowsVPDialer6.jar
...
copy .\VirtualPassageExe\VirtualPassageExe___Win32_IPv6_Release\VirtualPassageExe.exe .\Release\VirtualPassageExe.exe
...
jar -cmvf .\VirtualPassageExe\version.info .\Release\WindowsVPDialer6.jar -C .\Release SSLDrv.sys -C .\Release XTunnel.dll -C .\Release UninstallVTPassage.exe -C .\SSLDrv\Inf SSLDrv.txt -C .\Release VirtualPassageExe.exe
