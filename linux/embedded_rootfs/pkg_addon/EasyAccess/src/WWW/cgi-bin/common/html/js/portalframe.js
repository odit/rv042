...
if (100>heights){setTimeout("resizerwait()",300); }
if (heights==null){setTimeout("resizerwait()",300);}
parent.resizeme(heights);
}
function resizerwait(){
heights=document.body.scrollHeight;
if (100>heights){heights=460;}
if (heights==null){heights=460;}
parent.resizeme(heights);
}
var strftptitle='FTP&nbsp;Session';
var strftprename='Rename&nbsp;FTP&nbsp;Files';
var strftpupload='Upload&nbsp;FTP&nbsp;Files';
var strmycert='Current&nbsp;Certificates';
var strviewcert='General&nbsp;&#187;&nbsp;View&nbsp;Certificates';
var strnetworktools='Network&nbsp;Tools';
var strbookmarks='Bookmarks';
var strsettings='Settings';
var strnetplaces='My&nbsp;Network&nbsp;Places';
var strrestart='General&nbsp;&#187;&nbsp;Restart';
var strtcptunneling='Access&nbsp;&#187;&nbsp;TCP&nbsp;Tunneling';
var strstatus='General&nbsp;&#187;&nbsp;Status';
var straddbookmarks='Add&nbsp;Bookmarks';
var straddbookmark='Add&nbsp;Bookmark';
var streditbookmark='Edit&nbsp;Bookmark';
var strmydesktop='My&nbsp;Desktop';
var strapplications='Applications';
var strssslvpnclient='Virtual&nbsp;Passage';
var strvirtualtransport='Virtual&nbsp;Transport';
var blogin='Login';
