...
class RfbProto {
  ...
  RfbProto(String h, int p, VncViewer v) throws IOException {
    ...
    if (viewer.socketFactory == null) {
      ...
      jtc = new JTunnelClient(viewer.tunnelServer, host, port, viewer.tunnelSession, viewer.timeOut, viewer.HTTPS_PORT);
      jtc.createTunnel(); 
      sock = jtc.socket;
    } else {
/*
...
class JTunnelClient {
    ...
    JTunnelClient(String tunnelServer, String destinationHost, int destinationPort, String session, int timeOut, int HTTPS_PORT)
      {
	...
	//this.socket = factory.createSocket(this.tunnelServer, HTTPS_PORT); 
