...
public class CaviumSSLApplet extends JApplet implements ActionListener
  {
    static final long serialVersionUID = 0;
    JButton jbConnect;
    ...
    public void init()
      {
        ...
        label = new JLabel("Cavium Virtual Passage", JLabel.CENTER);
    ...
    private void connect()
      {
        ...
        dialer = 
        new CaviumDialer(args, Debug.getFileName(), Debug.getDebugEnabled(), isFullTunnelEnabled);
        ...
        mgr = new CaviumMgr(strServerIP.trim(),strOperatingSystem, isFullTunnelEnabled);
