 ...
 * for more details.
 *
 * RCSID $Id: state.h 5213 2010-05-30 08:37:19Z david.kao $
 */
...
/* Add by Daniel Cheng 2008.11.18 for phase2 FSM -->
 */
#define PHASE2_FSM_INITIATOR 0
#define PHASE2_FSM_RESPONDER 1
/* Daniel Cheng <-- */
