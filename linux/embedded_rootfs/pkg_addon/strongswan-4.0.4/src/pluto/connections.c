 ...
 * for more details.
 *
 * RCSID $Id: connections.c 6173 2010-08-16 08:49:08Z frank.chang $
 */
...
initiate_connection(const char *name, int whackfd)
{
	...
	else
	{
	     ...
	     */
	    //c->policy |= POLICY_UP; //Charles: Disable Keep alive so that delete payload will take effect
...
#endif
{
	...
	* we just used it to deco*received 296 bytes from 59.105.114.54:500 on eth2
	de the current message!
	 */
	if (psk == NULL)
