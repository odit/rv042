...
#define PACKAGE_STRING "Net-SNMP 5.4.1.2"
#endif
...
#define PACKAGE_VERSION "5.4.1.2"
#endif
...
#define NETSNMP_DEFAULT_MIBS ":IP-MIB:IF-MIB:TCP-MIB:UDP-MIB:HOST-RESOURCES-MIB:SNMPv2-MIB:RFC1213-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:UCD-SNMP-MIB:UCD-DEMO-MIB:SNMP-TARGET-MIB:NET-SNMP-AGENT-MIB:HOST-RESOURCES-TYPES:SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IP-FORWARD-MIB:NET-SNMP-EXTEND-MIB:UCD-DLMOD-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM:NET-SNMP-VACM-MIB:IPV6-ICMP-MIB:IPV6-MIB:IPV6-TCP-MIB:IPV6-UDP-MIB"
#else
...
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/tmp/root-rootfs/share/snmp/mibs"
...
#define SNMPLIBPATH "/tmp/root-rootfs/lib/snmp"
#define SNMPSHAREPATH "/tmp/root-rootfs/share/snmp"
#define SNMPCONFPATH "/tmp/root-rootfs/etc/snmp"
#define SNMPDLMODPATH "/tmp/root-rootfs/lib/snmp/dlmod"
...
#define NETSNMP_CONFIGURE_OPTIONS "'--build=i686-pc-linux-gnu' '--host=mips64-octeon-linux-gnu' '--with-endianness=little' '--prefix=/tmp/root-rootfs' '--disable-embedded-perl' '--enable-shared=no' '--enable-mib-config-checking' 'build_alias=i686-pc-linux-gnu' 'host_alias=mips64-octeon-linux-gnu'"
