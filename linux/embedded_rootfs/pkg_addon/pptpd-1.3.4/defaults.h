 ...
 * at run-time.
 *
 * $Id: defaults.h 2078 2009-02-24 11:53:19Z david $
 */
...
/* this define should be the max number of PPTP Server */
#define CONNECTIONS_DEFAULT		500
