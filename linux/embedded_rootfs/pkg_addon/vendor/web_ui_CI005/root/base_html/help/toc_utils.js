...
//	clickOnLink(linkID,docObj.link,'basefrm'); 
 ...
 //IRB   if (typeof document.body != "undefined") //scroll doesn work with NS4, for example
 //IRB       document.body.scrollTop=docObj.navObj.offsetTop
} 

function syncTOC()
{
if(top.contentiframe.myid!=null)
loadSynchPage(top.contentiframe.myid);
}